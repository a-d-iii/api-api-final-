...
async def login(
    ...
    for attempt in range(max_retries):
        ...
        try:
            ...
            print(f"Login failed due to invalid credentials or invalid format: {e}")
            raise
            ...
            raise VitapVtopClientError(f"Login failed after {max_retries} attempts due to unexpected error: {e}")
